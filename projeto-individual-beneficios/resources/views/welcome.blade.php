...
<body class="antialiased">
    <div class="relative flex items-top justify-center pt-8">
    ...
    <div class="max-w-6xl mx-auto sm:px-10 lg:px-8">
        ...
        <div class="mt-8 bg-white dark:bg-gray-800 overflow-hidden shadow sm:rounded-lg">
            <div class="grid grid-cols-1 md:grid-cols-2">
                <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-t-0 md:border-l bg-gray-100">
                    <div class="flex items-center">
                        <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" class="w-8 h-8 text-gray-500"><path d="M3 9a2 2 0 012-2h.93a2 2 0 001.664-.89l.812-1.22A2 2 0 0110.07 4h3.86a2 2 0 011.664.89l.812 1.22A2 2 0 0018.07 7H19a2 2 0 012 2v9a2 2 0 01-2 2H5a2 2 0 01-2-2V9z"></path><path d="M15 13a3 3 0 11-6 0 3 3 0 016 0z"></path></svg>
                        <div class="ml-4 text-lg leading-7 font-semibold"><a href="{{ route('clients.index') }}" class="underline text-gray-900 dark:text-white">Clientes</a></div>
                    </div>
                    <div class="ml-12">
                ...
                <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-t-0 md:border-l bg-gray-100">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4 text-lg leading-7 font-semibold"><a href="{{ route('payments.index') }}" class="underline text-gray-900 dark:text-white">Pagamentos</a></div>
                    </div>
                    <div class="ml-12">
                        <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
